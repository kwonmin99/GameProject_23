...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizationSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Settings Header
            ReachEditorHandler.DrawHeader(customSkin, "Options Header", 8);
            ...
            {
                defaultLanguageIndex = EditorGUILayout.Popup(defaultLanguageIndex, languageList.ToArray());
                lsTarget.defaultLanguageID = languageList[defaultLanguageIndex];
                lsTarget.defaultLanguageIndex = defaultLanguageIndex;
            }
            ...
            ReachEditorHandler.DrawHeader(customSkin, "Languages Header", 14);
            GUILayout.Space(-3);
            ...
            #region Support
            ReachEditorHandler.DrawHeader(customSkin, "Support Header", 14);
